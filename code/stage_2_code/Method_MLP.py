...
# Copyright (c) 2022 Noah Rose Ledesma
# License: TBD
...
class Method_MLP(method, nn.Module):
    ...
    def __init__(self, nFeatures, nCategories, mName, mDescription):
        method.__init__(self, mName, mDescription)
        nn.Module.__init__(self)
        # check here for nn.Linear doc: https://pytorch.org/docs/stable/generated/torch.nn.Linear.html
        self.fc_layer_1 = nn.Linear(nFeatures, 256)
        self.activation_func_1 = nn.Tanh()

        self.fc_layer_2 = nn.Linear(256, 128)
        self.activation_func_2 = nn.Tanh()

        self.fc_layer_3 = nn.Linear(128, nCategories)
    ...
    def forward(self, x):
        ...
        hidden_layer_1 = self.activation_func_1(self.fc_layer_1(x))
        hidden_layer_2 = self.activation_func_2(self.fc_layer_2(hidden_layer_1))
        
        # outout layer result
        # we do softmax along dim=1 to get the normalized classification probability distributions for each instance
        return self.activation_func_3(self.fc_layer_3(hidden_layer_2))
